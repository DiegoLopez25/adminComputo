...
<div class="container-fluid">
    ...
    <div class="row mb-3 col-sm-12 col-xs-12">
        <div class="col-md-3 col-sm-12 offset-md-9">
            <a href="<?= base_url('dispositivo/addEdit/0') ?>" class="btn btn-success float-right ml-0"><i class="fas fa-plus"></i> Nuevo <?=$title?></a>
        </div>
    </div>
                                            ...
                                            <?php if ($dispositivos) :?>
                                                <?php foreach ($dispositivos as $d) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $d->centro_computo; ?></td>
                                                        <td><span class="<?php if($d->estado=="Activo"){ echo 'bg-success';}else{ echo 'bg-danger';}?> text-white rounded"><?php echo $d->estado; ?></span></td>
                                                        <td class="project-actions ">
                                                            <a href="<?= base_url('/dispositivo/addEdit/'.$d->id)?>" class="btn btn-info btn-sm"><i class="fa fa-pencil-alt"></i></a>
                                                            <a data-toggle="modal" data-target="#modal-delete" onclick="seleccionarDispositivoParaBorrar(<?= $d->id ?>)" class="btn btn-danger btn-sm"> <i class=" text-white fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url("/dispositivo/delete"); ?>" id="frmDelete" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-danger" onclick="borrarDispositivo()"><i class="fa fa-trash"></i>S&iacute, Eliminar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function seleccionarDispositivoParaBorrar(val){
