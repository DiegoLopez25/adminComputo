...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between col-sm-12 col-xs-12">
        ...
        <div class="d-none d-sm-inline-block"><a href="<?= site_url('/dashboard') ?>">Home</a> / <a>Lista centros de computo</a></div>
    </div>
    <div class="row mb-3 col-sm-12 col-xs-12">
        <div class="col-md-3 col-sm-12 offset-md-9">
            <a href="<?= base_url('centro-computo/addEdit/0') ?>" class="btn btn-success float-right ml-0"><i class="fas fa-plus"></i> Nuevo centro de computo</a>
        </div>
    </div>
                ...
                <div class="card-body ">
                    <div class="table-responsive">
                        <div class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="tbl_centrocomputo" class="table table-hover table-bordered dataTable">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>Nombre</th>
                                                ...
                                                <?php foreach ($centroComputo as $ct) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="project-actions ">
                                                            ...
                                                            <a data-toggle="modal" data-target="#modal-delete" onclick="seleccionarClienteParaBorrar(<?= base_url('/centro-computo/addEdit/'.$ct->id)?>)" class="btn btn-danger btn-sm"> <i class=" text-white fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
