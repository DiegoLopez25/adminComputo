...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between col-sm-12 col-xs-12">
        ...
        <div class="d-none d-sm-inline-block"><a href="<?=site_url('/dashboard')?>">Home</a> / <a href="http://">Centros de computo</a></div> 
    </div>
    <div class="row mb-3 col-sm-12 col-xs-12">
        <div class="col-md-3 col-sm-12 offset-md-9 ">
            <a href="#" class="btn btn-success float-right"><i class="fas fa-plus"></i>Nuevo</a>
        </div>
    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="http://codeigniter-crud-diego.test/cliente/delete" id="frmDelete" method="post">
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="button" class="btn btn-danger" onclick="borrarCliente()"> <i class="fas fa-trash"></i>Sí, Eliminar</button>
                        </div>
                    </div>
                </div>
            </div>
