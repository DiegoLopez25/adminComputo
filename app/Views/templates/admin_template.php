...
<head>
    ...
    <title>Admin Computo</title>
    
    <!-- Custom fonts for this template-->
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url()?>/img/pc.png">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= site_url("/dashboard")?>">
                ...
                <div class="sidebar-brand-text">Sistema computo</div>
            </a>
...
<!-- End of Topbar -->
    ...
    <script src="<?= base_url()?>/vendor/bs-custom-file-input/bs-custom-file-input.min.js"></script>
